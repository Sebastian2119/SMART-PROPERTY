...
{
    public partial class  frmEmpleado_RegistroUsuario: System.Web.UI.Page
    {
        ...
        {
            DataTable dtRol = conexionUs.cargarRolcpEmpleado();
        ...
        {
            Response.Redirect("frmEmpleado_RegistroUsuario.aspx");
        }
    }
}