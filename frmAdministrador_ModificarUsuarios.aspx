<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmAdministrador_ModificarUsuarios.aspx.cs" Inherits="SmartPropertySIW.frmAdministradorModificarUsuarios" EnableEventValidation="false" %>
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                <li class="active"><a href="frmAdministradorModificarUsuarios.aspx">Modificar Usuarios</a></li>
                                <li class="divider"></li>
            ...
            <div class="col-sm-8 text-center">
                ...
                <div class="col-sm-8 text-left">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtNumeroCelular" type="number" class="form-control" placeholder="Ingresar Numero De Celular" name="txtCelular" runat="server"></asp:TextBox>
                    </div>
                    <div class="form-group">
