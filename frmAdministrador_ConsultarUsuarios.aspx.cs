...
{
    public partial class frmAdministrador_ConsultarUsuarios : System.Web.UI.Page
    {
        ...
        protected void btnBuscarUsuario_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                DataTable dtDatosUsuario = conexionModUs.BusquedaConsultarUsuario(int.Parse(TxtBuscarUsuario.Text));
