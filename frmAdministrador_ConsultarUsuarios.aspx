<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmAdministrador_ConsultarUsuarios.aspx.cs" Inherits="SmartPropertySIW.Formularios.frmAdministrador_ConsultarUsuarios" %>
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                <li class="active"><a href="#">Consultar Usuarios</a></li>
                                <li class="divider"></li>
        ...
        <div class="container-fluid text-center">
            <div class="row content">
                ...
                <div class="col-sm-8">
                    ...
                    <div class="input-group">
                        <asp:TextBox ID="TxtBuscarUsuario" type="number" required="required" runat="server" class="form-control" placeholder="Buscar Por Documento de Identificacion"></asp:TextBox>
