<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmVerInmuebles_Alquiler.aspx.cs" Inherits="SmartPropertySIW.Formularios.frmVerInmuebles_Alquiler" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Ver Inmuebles Alquiler</title>
    <meta charset="utf-8" />
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="divider"></li>
                                <li class="active"><a href="frmVerInmuebles_Alquiler.aspx">Alquiler De Inmuebles</a></li>
                            </ul>
                        </li>                        
                    </ul>
                </div>
