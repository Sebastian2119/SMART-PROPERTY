...
{
    public partial class frmVerInmuebles_Arriendo : System.Web.UI.Page
    {
        ...
        {
            DataTable dtDatosTipoInmueble = conexion.BusquedafiltroArriendo();
        ...
        {
            DataTable dtDatosTipoInmueble = conexion.BusquedaFiltroArriendoTipoInmueble(int.Parse(ddlTipoInmueble.Text));
            gvConsultarInmuebles.DataSource = dtDatosTipoInmueble;
            gvConsultarInmuebles.DataBind();
        }
        ...
        {
            DataTable dtDatosTipoInmueble = conexion.BusquedafiltroArriendoUbicacion(int.Parse(ddlUbicacion.Text));
            gvConsultarInmuebles.DataSource = dtDatosTipoInmueble;
            gvConsultarInmuebles.DataBind();
        }
