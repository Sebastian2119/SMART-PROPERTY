<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmEmpleado.aspx.cs" Inherits="SmartPropertySIW.Formularios.frmEmpleado" %>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="frmEmpleado.aspx"><span class="glyphicon glyphicon-home"></span>&nbsp Inicio</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="divider"></li>
                                <li><a href="frmEmpleado_ModificarUsuarios.aspx">Modificar Inmuebles</a></li>
                            </ul>
                        </li>
                    </ul>
