<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmEmpleado_ConsultarInmuebles.aspx.cs" Inherits="SmartPropertySIW.Formularios.frmEmpleado_ConsultarInmuebles" %>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="divider"></li>
                                <li class="active"><a href="frmEmpleado_ConsultarInmuebles.aspx">Consultar Inmuebles</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
