<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmAdministrador_RegistroInmuebles.aspx.cs" Inherits="SmartPropertySIW.Formularios.frmRegistroInmuebles" %>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="divider"></li>
                                <li class="active"><a href="frmRegistroInmuebles.aspx">Registrar Inmuebles</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
            ...
            <div class="col-sm-8 text-center">
                ...
                <div class="col-sm-8 text-left">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtDireccionCliente" Style="text-transform: uppercase" required="required" type="text" class="form-control" placeholder="Ingresar Dirección" name="txtApellidosCliente" runat="server"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label for="Direccion">Celular Cliente:</label>
                        <asp:TextBox ID="txtCelularCliente" type="number" MaxLength="10" required="required" class="form-control" placeholder="Ingresar Celular" name="txtCelularCliente" runat="server"></asp:TextBox>
                    </div>
                    <hr />
                    <h3><span class="glyphicon glyphicon-check"></span>&nbsp Datos del Aviso</h3>
                    <div class="dropdown">
                        <label for="TipoOferta">Tipo Oferta:</label>
                        <asp:DropDownList ID="ddlTipoOferta" class="btn btn-default dropdown-toggle" Style="width: 100%; text-align: left" required="required" runat="server"></asp:DropDownList>
                    </div>
                    <div class="dropdown">
                        <label for="Tipo Inmueble">Tipo Inmueble:</label>
                        <asp:DropDownList ID="ddlTipoInmueble" class="btn btn-default dropdown-toggle" Style="width: 100%; text-align: left" required="required" runat="server"></asp:DropDownList>
                    </div>
                    <hr />
                    ...
                    <div class="dropdown">
                        ...
                        <asp:DropDownList ID="ddlUbicacion" class="btn btn-default dropdown-toggle" Style="width: 100%; text-align: left" required="required" runat="server"></asp:DropDownList>
                    </div>
                    <div class="form-group">
                        <label for="Barrio">Barrio Donde Esta Ubicado El Inmueble:</label>
                        <asp:TextBox ID="txtBarrio" Style="text-transform: uppercase" required="required" type="text" class="form-control" placeholder="Ingresar Un Barrio" name="txtBarrio" runat="server"></asp:TextBox>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtPrecioAvaluado" MaxLength="20" type="number" class="form-control" placeholder="Ingrese El PrecioAvaluado" name="txtPrecioAvaluado" required="required" runat="server"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label for="PrecioCliente">Precio Cliente:</label>
                        <asp:TextBox ID="txtPrecioCliente" MaxLength="20" type="number" class="form-control" placeholder="Ingrese Precio Del Cliente" name="txtPrecio Cliente" required="required" runat="server"></asp:TextBox>
                    </div>
                    <div class="form-group col-sm-4 ">
                        <label for="Area">Area M2:</label>
                        <asp:TextBox ID="txtArea" type="text" MaxLength="45" Style="text-transform: uppercase" required="required" class="form-control" placeholder="Area En M2" name="txtArea" runat="server"></asp:TextBox>
                    </div>
                    <div class="form-group col-sm-4">
                        <label for="Estrato">Estrato:</label>
                        <asp:TextBox ID="txtEstrato" type="number" required="required" min="1" max="6" class="form-control" name="txtEstrato" runat="server"></asp:TextBox>
                    </div>
                    <div class="form-group col-sm-4">
                        <label for="habitaciones">Habitaciones:</label>
                        <asp:TextBox ID="txtHabitaciones" type="number" required="required" class="form-control" name="txtHabitaciones" runat="server" MaxLength="1"></asp:TextBox>
                    </div>
                    <div class="form-group col-sm-4">
                        <label for="Pisos">Pisos:</label>
                        <asp:TextBox ID="txtPisos" type="number" required="required" class="form-control" name="txtPisos" runat="server" MaxLength="1"></asp:TextBox>
                    </div>
                    <div class="form-group col-sm-4">
                        <label for="Baños">Baños:</label>
                        <asp:TextBox ID="txtBaños" type="number" required="required" class="form-control" name="txtBaños" runat="server" MaxLength="1"></asp:TextBox>
                    </div>
                    <div class="form-group col-sm-4">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <asp:DropDownList ID="ddlEstado" class="btn btn-default dropdown-toggle" Style="width: 100%; text-align: left" required="required" runat="server"></asp:DropDownList>
                    </div>
                    <div class="form-group col-sm-6">
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="form-group">
                            <asp:TextBox ID="txtUsuarioProvicional" visible="false" runat="server"></asp:TextBox>
                        </div>
