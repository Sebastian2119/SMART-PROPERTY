<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmCliente_ModificarInmuebles.aspx.cs" Inherits="SmartPropertySIW.Formularios.frmCliente_ModificarInmuebles" %>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="divider"></li>
                                <li class="active"><a href="frmCliente_ModificarInmuebles.aspx">Mis Inmuebles</a></li>
                            </ul>
                        </li>                        
                    </ul>                    
                </div>
            ...
            <div class="col-sm-8 text-center">
                ...
                <div class="col-sm-8 text-left">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <asp:TextBox ID="txtValorAdministracion"  required="required" type="number" class="form-control" placeholder="Ingrese Valor Aministración" name="txtValorAdministracion" runat="server"></asp:TextBox>
                    </div>
