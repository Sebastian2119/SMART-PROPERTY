<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmEmpleado_ModificarUsuarios.aspx.cs" Inherits="SmartPropertySIW.frmEmpleado_ModificarUsuarios" EnableEventValidation="false" %>
    ...
    <form id="form1" runat="server">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                <li class="active"><a href="frmEmpleado_ModificarUsuarios.aspx">Modificar Usuarios</a></li>
                                <li class="divider"></li>
        ...
        <div class="container-fluid text-left">
            ...
            <div class="col-sm-8 text-center">
                <h1>Modificar o Eliminar Usuarios</h1>
                ...
                <div class="col-sm-8 text-left">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtDocumento" required="required" type="text" class="form-control" placeholder="Ingresar Numero De Documento" name="txtDocumento" runat="server"></asp:TextBox>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtNumeroCelular" required="required" type="number" class="form-control" placeholder="Ingresar Numero De Celular" name="txtCelular" runat="server"></asp:TextBox>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtUsuario" required="required" type="text" class="form-control" placeholder="smartpropertysiw@gmail.com" name="txtUsuario" runat="server"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label for="Password">Contraseña:</label>
                        <asp:TextBox ID="txtContraseña" required="required" type="password" class="form-control" name="txtContraseña" runat="server" ></asp:TextBox>
                    </div>                    
                    <div class="dropdown">
        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-8" id="myWorkContent">
                <asp:GridView ID="gvDatosUsuarios" class="table table-bordered bs-table" runat="server" Style="border: 0" OnSelectedIndexChanged="gvDatosUsuarios_SelectedIndexChanged" OnRowEditing="gvDatosUsuarios_RowEditing" OnRowDeleting="gvDatosUsuarios_RowDeleting">
                    <Columns>
                        <asp:ButtonField CommandName="Select" ControlStyle-CssClass="btn btn-success" Text="Seleccionar">
                            <ControlStyle CssClass="btn btn-success"></ControlStyle>
                        </asp:ButtonField>
                        <asp:ButtonField CommandName="Edit" ControlStyle-CssClass="btn btn-info" Text="Modificar">
                            <ControlStyle CssClass="btn btn-info"></ControlStyle>
                        </asp:ButtonField>
                        <asp:ButtonField CommandName="Delete" ControlStyle-CssClass="btn btn-danger" Text="Eliminar">
