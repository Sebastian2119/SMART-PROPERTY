<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmEmpleado_ModificarInmuebles.aspx.cs" Inherits="SmartPropertySIW.Formularios.frmEmpleado_ModificarInmuebles" %>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="divider"></li>
                                <li class="active"><a href="frmEmpleado_ModificarInmuebles.aspx">Modificar Inmuebles</a></li>
                            </ul>
                        </li>                        
                    </ul>                    
                </div>
            ...
            <div class="col-sm-8 text-center">
                ...
                <div class="col-sm-8 text-left">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtCelularCliente" required="required" type="text" class="form-control" placeholder="Ingresar Celular" name="txtCelularCliente" runat="server"></asp:TextBox>
                    </div>
                    <hr />
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtPrecioAvaluado" required="required" type="text" class="form-control" placeholder="Ingrese El PrecioAvaluado" name="txtPrecioAvaluado" runat="server"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label for="PrecioCliente">Precio Cliente:</label>
                        <asp:TextBox ID="txtPrecioCliente" required="required" type="text" class="form-control" placeholder="Ingrese Precio Del Cliente" name="txtPrecio Cliente" runat="server"></asp:TextBox>
                    </div>
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <asp:TextBox ID="txtPisos" required="required" type="number" class="form-control" name="txtPisos" runat="server"></asp:TextBox>
                    </div>
                    <div class="form-group col-sm-4">
                        <label for="Baños">Baños:</label>
                        <asp:TextBox ID="txtBaños" required="required" type="number" class="form-control" name="txtBaños" runat="server"></asp:TextBox>
                    </div>
                    <div class="form-group col-sm-4">
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <br />
                        <h3><span class="glyphicon glyphicon-camera"></span>&nbsp Fotos Del Inmueble</h3>
                        <div class="form-group">
                            <div class="col-lg-6">
                            </div>
                        </div>
