<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmCliente_RegistroInmuebles.aspx.cs" Inherits="SmartPropertySIW.Formularios.Cliente_RegistroInmuebles" %>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">                                
                                <li class="active"><a href="frmCliente_RegistroInmuebles.aspx">Registrar Inmuebles</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
            ...
            <div class="col-sm-8 text-center">
                ...
                <div class="col-sm-8 text-left">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtCelularCliente" MaxLength="10" Style="text-transform:uppercase" required="required" type="number" class="form-control" placeholder="Ingresar Celular" name="txtCelularCliente" runat="server"></asp:TextBox>
                    </div>
                    <hr />
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <asp:TextBox ID="txtEstrato" required="required" type="number" class="form-control" name="txtEstrato" runat="server" MaxLength="1"></asp:TextBox>
                    </div>
                    <div class="form-group col-sm-4">
                        <label for="habitaciones">Habitaciones:</label>
                        <asp:TextBox ID="txtHabitaciones" required="required" type="number" class="form-control" name="txtHabitaciones" runat="server" MaxLength="1"></asp:TextBox>
                    </div>
                    <div class="form-group col-sm-4">
