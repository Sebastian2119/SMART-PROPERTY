<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmVerInmuebles_Arriendo.aspx.cs" Inherits="SmartPropertySIW.Formularios.frmVerInmuebles_Arriendo" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Ver Inmuebles Arriendo</title>
    <meta charset="utf-8" />
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav">
                        <li><a href="frmindex.aspx"><span class="glyphicon glyphicon-home"></span>&nbsp Inicio</a></li>
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="divider"></li>
                                <li class="active"><a href="frmVerInmuebles_Arriendo.aspx">Inmuebles En Arriendo</a></li>
                                <li class="divider"></li>
