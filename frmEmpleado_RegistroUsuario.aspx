<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmEmpleado_RegistroUsuario.aspx.cs" Inherits="SmartPropertySIW.frmEmpleado_RegistroUsuario" %>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                <li class="active"><a href="frmEmpleado_RegistroUsuario.aspx">Registrar Usuarios</a></li>
                                <li class="divider"></li>
            ...
            <div class="col-sm-8 text-center">
                ...
                <div class="col-sm-8 text-left">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtDocumento" type="text" MaxLength="11" class="form-control" placeholder="Ingresar Numero De Documento" name="txtDocumento" runat="server" required="required"></asp:TextBox>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtDireccion" type="text" Style="text-transform: uppercase" class="form-control" placeholder="Ingrese su Dirección" name="txtDireccion" runat="server"></asp:TextBox>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtCorreo" MaxLength="45" Style="text-transform: uppercase" type="email" class="form-control" placeholder="smartpropertysiw@gmail.com" name="txtCorreo" runat="server" required="required"></asp:TextBox>
                    </div>
                    <hr />
