...
{
    public partial class frmVerInmuebles_Alquiler : System.Web.UI.Page
    {
        ...
        {
            DataTable dtDatosTipoInmueble = conexion.BusquedafiltroAlquiler();
        ...
        {
            DataTable dtDatosTipoInmueble = conexion.BusquedaFiltroAlquilerTipoInmueble(int.Parse(ddlTipoInmueble.Text));
            gvConsultarInmuebles.DataSource = dtDatosTipoInmueble;
            gvConsultarInmuebles.DataBind();
        }
        ...
        {
            DataTable dtDatosTipoInmueble = conexion.BusquedafiltroAlquilerUbicacion(int.Parse(ddlUbicacion.Text));
            gvConsultarInmuebles.DataSource = dtDatosTipoInmueble;
            gvConsultarInmuebles.DataBind();
        }
