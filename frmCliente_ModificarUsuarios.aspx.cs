...
{
    public partial class frmCliente_ModificarUsuarios : System.Web.UI.Page
    {
        ...
        {
            DataTable dtRol = conexionModUs.cargarRol();
        ...
        private void cargarMisDatos()
        {
            ...
            ddlTipoDocumento.CssClass = "btn btn-default dropdown-toggle";
            txtDocumento.Enabled = false;
            txtDocumento.CssClass = "form-control";
            txtFechaNacimiento.Enabled = false;
            txtFechaNacimiento.CssClass = "form-control";
            ddlTipoUsuario.Enabled = false;
            ddlTipoUsuario.CssClass = "btn btn-default dropdown-toggle";

            DataTable dtCargarcampos = new DataTable();
            dtCargarcampos = conexionModUs.SeleccionarMisDatos(int.Parse(Session["idUsuario"].ToString()));
        ...
        protected void btnActualizar_Click(object sender, EventArgs e)
        {
            if (txtNombres.Text == "")
            {
                lblMensaje.Text = "No Se Permiten Campos Vacios";
        ...
        {
            Response.Redirect("frmAdministrador_ModificarUsuarios.aspx");
        }                    
    }
}