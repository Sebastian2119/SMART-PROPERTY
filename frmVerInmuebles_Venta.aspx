<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmVerInmuebles_Venta.aspx.cs" Inherits="SmartPropertySIW.Formularios.frmVerInmuebles_Venta" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Ver Inmuebles Venta</title>
    <meta charset="utf-8" />
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                <li class="active"><a href="frmVerInmuebles_Venta.aspx">Inmuebles En Venta</a></li>
                                <li class="divider"></li>
