...
{
    public partial class frmVerInmuebles_Venta : System.Web.UI.Page
    {
        ...
        {
            DataTable dtDatosTipoInmueble = conexion.BusquedafiltroVenta();
        ...
        {
            DataTable dtDatosTipoInmueble = conexion.BusquedaFiltroVentaTipoInmueble(int.Parse(ddlTipoInmueble.Text));
            gvConsultarInmuebles.DataSource = dtDatosTipoInmueble;
            gvConsultarInmuebles.DataBind();
        }
        ...
        {
            DataTable dtDatosTipoInmueble = conexion.BusquedafiltroVentaUbicacion(int.Parse(ddlUbicacion.Text));
            gvConsultarInmuebles.DataSource = dtDatosTipoInmueble;
            gvConsultarInmuebles.DataBind();
        }
